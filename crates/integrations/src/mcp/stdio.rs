...
use super::config::{McpTransport, ScopedMcpServerConfig};
use super::lifecycle::{McpDegradedReport, McpErrorSurface, McpFailedServer, McpLifecyclePhase};
...
mod tests {
    ...
    use crate::mcp::utils::mcp_tool_name;
    ...
    fn rejects_non_stdio_bootstrap() {
        let config = ScopedMcpServerConfig {
            scope: ConfigSource::Local,
            config: McpServerConfig::Sdk(crate::mcp::config::McpSdkServerConfig {
