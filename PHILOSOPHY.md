...
The Python rewrite was a byproduct. The Rust rewrite was also a byproduct. The real thing worth studying is the **system that produced them**: an orbit-based coordination loop where humans give direction and autonomous orbits execute the work.

Orbit is not just a codebase. It is a public demonstration of what happens when:
...
A person can type a sentence from a phone, walk away, sleep, or do something else. The orbits read the directive, break it into tasks, assign roles, write code, run tests, argue over failures, recover, and push when the work passes.

That is the philosophy: **humans set direction; orbits perform the labor.**

## The Three-Part System

### 1. OmX (`oh-my-codex`)
[oh-my-codex](https://github.com/frontal-labs/oh-my-codex) provides the workflow layer.
...
### 2. orbithip
[orbithip](https://github.com/frontal-labs/orbithip) is the event and notification router.
...
[oh-my-openagent](https://github.com/frontal-labs/oh-my-openagent) handles multi-agent coordination.
...
Orbit demonstrates that a repository can be:

- **autonomously built in public**
- coordinated by orbits rather than human pair-programming alone
...
**Orbit is a demo of autonomous software development.**

Humans provide direction.
Orbits coordinate, build, test, recover, and push.
